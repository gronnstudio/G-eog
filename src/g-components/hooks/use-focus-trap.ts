...
// Focus containment for overlay dialogs (curtain menus, dock sheets,
// language panels). While `active`: Tab wraps inside the container,
// Escape calls `onEscape`, and elements under an [inert] ancestor don't
// count. On deactivate, focus returns to wherever it was before the
// dialog opened — the trigger button, per the ARIA dialog pattern.
